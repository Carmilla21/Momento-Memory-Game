(function () {
  ...
  function timeCountUp() {
    ...
    const minutes = Math.floor(completeTime / 60); // turns seconds to minutes
  ...
  const easyCards = document.querySelectorAll('.easyCard');
  const mediumCards = document.querySelectorAll('.mediumCard');
  const hardCards = document.querySelectorAll('.hardCard');
